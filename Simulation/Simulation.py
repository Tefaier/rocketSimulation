...
rocketRotation = Rotation.from_quat(quat.from_spherical_coords(np.deg2rad(90), 0)) * earthRotation
...
mksMass = 440000
mksFlyHeight = 418000
mksRotationProjected = Rotation.from_quat(quat.from_spherical_coords(np.deg2rad(90), 0)) * earthRotation
